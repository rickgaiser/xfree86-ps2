...
#define INTERLACEMIX    1120
#define VIDEOMODE       1121
...
#define TT_NOINTERLACE	1131

#ifdef INIT_CONFIG
SymTabRec TimingTab[] = {
  { TT_INTERLACE,	"interlace"},
  { TT_NOINTERLACE,	"nointerlace"},
  { -1,			"" },
};
